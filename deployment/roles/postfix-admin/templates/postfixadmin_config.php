...
$CONF['setup_password'] = '{{ postfixadmin_setup_pw_hash }}';
...
$CONF['database_password'] = '{{ mysql_postfixadmin_pw }}';
...
$CONF['admin_email'] = '{{ admin_email_address }}';
...
$CONF['default_aliases'] = array (
    'abuse' => '{{ admin_email_address }}',
    'hostmaster' => '{{ admin_email_address }}',
    'postmaster' => '{{ admin_email_address }}',
    'webmaster' => '{{ admin_email_address }}'
);
...
$CONF['vacation_domain'] = 'autoreply.{{ host_name }}';
...
Welcome to your new {{ host_name }}  account. If you have any questions
regarding this service, don't hesitate to ask!

You can reach me me as
